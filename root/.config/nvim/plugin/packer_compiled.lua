...
local package_path_str = "~/.cache/nvim/packer_hererocks/2.0.5/share/lua/5.1/?.lua;~/.cache/nvim/packer_hererocks/2.0.5/share/lua/5.1/?/init.lua;~/.cache/nvim/packer_hererocks/2.0.5/lib/luarocks/rocks-5.1/?.lua;~/.cache/nvim/packer_hererocks/2.0.5/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "~/.cache/nvim/packer_hererocks/2.0.5/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  ["AutoSave.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/AutoSave.nvim"
  },
  LuaSnip = {
  ...
  ["TrueZen.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/TrueZen.nvim"
  },
  ["better-escape.vim"] = {
    config = { "\27LJ\1\2=\0\0\2\0\3\0\0064\0\0\0%\1\1\0>\0\2\0027\0\2\0>\0\1\1G\0\1\0\vescape\19plugins.others\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/better-escape.vim"
  },
  ["cheatsheet.nvim"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "~/.local/share/nvim/site/pack/packer/opt/cheatsheet.nvim"
  },
  ["dashboard-nvim"] = {
    commands = { "Dashboard", "DashboardNewFile", "DashboardJumpMarks", "SessionLoad", "SessionSave" },
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/dashboard-nvim"
  },
  ["friendly-snippets"] = {
    loaded = false,
    needs_bufread = false,
  ...
  ["galaxyline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
  ...
  ["lspkind-nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/lspkind-nvim"
  },
  neoformat = {
    commands = { "Neoformat" },
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/neoformat"
  },
  ["neoscroll.nvim"] = {
    config = { "\27LJ\1\2@\0\0\2\0\3\0\0064\0\0\0%\1\1\0>\0\2\0027\0\2\0>\0\1\1G\0\1\0\14neoscroll\19plugins.others\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/neoscroll.nvim"
  },
  ["nvim-autopairs"] = {
  ...
  ["nvim-bufferline.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/nvim-bufferline.lua"
  },
  ["nvim-colorizer.lua"] = {
    config = { "\27LJ\1\2@\0\0\2\0\3\0\0064\0\0\0%\1\1\0>\0\2\0027\0\2\0>\0\1\1G\0\1\0\14colorizer\19plugins.others\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/nvim-colorizer.lua"
  },
  ["nvim-comment"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/nvim-comment"
  },
  ["nvim-compe"] = {
    after = { "nvim-autopairs" },
    after_files = { "~/.local/share/nvim/site/pack/packer/opt/nvim-compe/after/plugin/compe.vim" },
    config = { "\27LJ\1\2-\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0\18plugins.compe\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/nvim-compe",
    wants = { "LuaSnip" }
  },
  ["nvim-lspconfig"] = {
  ...
  ["nvim-lspinstall"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/nvim-lspinstall"
  },
  ["nvim-tree.lua"] = {
  ...
  ["plenary.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/plenary.nvim"
  },
  ["popup.nvim"] = {
    load_after = {
      ["plenary.nvim"] = true
    ...
    loaded = false,
    needs_bufread = false,
    path = "~/.local/share/nvim/site/pack/packer/opt/popup.nvim"
  },
  ...
  ["vim-fugitive"] = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "~/.local/share/nvim/site/pack/packer/opt/vim-fugitive"
  },
  ["vim-matchup"] = {
